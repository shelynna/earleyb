      ...
      <main className="w-full overflow-hidden bg-[#FAFAFA] min-h-screen">
        <section className="pt-[180px] px-4 md:px-10 max-w-[1200px] mx-auto flex flex-col items-center text-center relative overflow-visible pb-[80px]">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mb-10 relative z-10">
            We do not just fix devices. We build confidence, block cyber threats before they happen, and relieve staff burdens so everyone can thrive.
          </p>
          <div className="flex flex-wrap justify-center gap-4 relative z-10">
            <Link href="/book?service=Tech%20Concierge" className="bg-black text-white font-bold rounded-full hover:bg-black/80 transition-all duration-300 px-8 py-3 text-xs uppercase tracking-widest shadow-md">
              Book a Consultation
            </Link>
        ...
        <section className="py-12 md:py-20 px-4 md:px-10 max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            ...
            <div className="bg-white p-8 md:p-10 rounded-[32px] flex flex-col items-start">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                We know tech can be frustrating and overwhelming. Our concierges are hand-picked for kindness, patience, and the ability to translate complex technology jargon into plain, visual instruction.
              </p>
            ...
            <div className="bg-white p-8 md:p-10 rounded-[32px] flex flex-col items-start">
              ...
              <InlineTextLink href="/portfolio/senior-living" className="text-teal-600 font-semibold text-sm hover:underline">
                View Community Case Studies
              </InlineTextLink>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-[1440px] rounded-[32px] bg-action px-6 py-16 text-center text-white md:py-20">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex justify-center">
                <Link href="/book?service=Tech%20Concierge" className="bg-white text-black font-bold rounded-full hover:bg-gray-100 transition-all duration-300 px-8 py-3 text-xs uppercase tracking-widest shadow-lg">
